                    ...
                    <form v-on:submit.prevent="saveForm()">
                        <div class="card-body">
                            ...
                            <div class="form-group row required">
                                ...
                                <div class="col-md-9">
                                    <input type="symbol" id="symbol-input" v-model="currency.symbol" v-bind:class="{ 'is-invalid': err && err.symbol }" class="form-control" placeholder="Enter Symbol">
...
<script>
    export default {
        mounted() {
            ...
            app.currencyId = id;
            axios.get('/bapi/currency/' + id)
            .then(function (resp) {
                app.currency = resp.data.data;
            })
            .catch(function () {
        ...
        methods: {
            saveForm() {
                ...
                axios.patch('/bapi/currency/' + app.currencyId, newCurrency)
                    .then(function (resp) {
